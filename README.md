...
# アプリ開発の背景
コロナ渦をきっかけとして、リモートワークする機会が増えています。それに伴い自宅にいる時間も増えていると予想できます。<br>
普段の職場における労働と比べ、下記2点の傾向が増加していると考えられます。<br>
・一人で部屋にこもりがち。<br>
...
| **課題**                                                                                 | **課題解決手段**                                             | **具体的機能**                          |
| --------------------------------------------------------------------------------------- | ---------------------------------------------------------- | -------------------------------------- |
| 対面に代わる、孤独を感じない仕組みの確立<br>⇨自分のアクションに対して<br>　他者からのリアクションがある | 整理整頓、清掃されたデスクの<br>画像を共有する<br>(自分のアクション) | ① 画像投稿機能                          |
| ↑                                                                                       | ↑                                                          | ② 投稿画像の一覧表示機能                  |
| ↑                                                                                       | 共有した画像にコメントを<br>投稿できる(リアクション)               | ③ コメント投稿機能                       |
| 清潔が保たれている空間の確保                                                                 | 清掃箇所の登録、定期的な提案                                    | ④ 清掃箇所及び関連情報の<br>　登録機能     |
| ↑                                                                                       | ↑                                                          | ⑤ アルゴリズムの実装、提案機能             |
| ↑                                                                                       | 部屋やデスク上の異常<br>(散らかっている状態)を検出する             | ⑥ ラズベリーパイ+カメラ<br>　による監視機能 |
| ↑                                                                                       | 検出した異常をアプリへ通知する                                  | ⑦ 異常状態の通知機能                     |
